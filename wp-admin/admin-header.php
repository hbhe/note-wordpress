 ...
 */
/*
$hook_suffix 是当前执行的php脚本文件名, 如 $hook_suffix = 'index.php' 或'profile.php', 'edit.php'等
*/ 
...
<div id="wpwrap">
<?php require(ABSPATH . 'wp-admin/menu-header.php'); /* 显示后台左侧主菜单adminmenu */ ?>
<div id="wpcontent">
