 ...
 */
 /*
每个页面的title是根据当前显示的是什么类型的页面来定的,如
如页面是post时, 则页面的title取当前post的title
 */
function wp_get_document_title() {
	 ...
	 */
	 ...
	 /* 
	 连常量'-'都可以用apply_filters()包装后提供!
	 默认是-, 可以通过定义 document_title_separator 改变它
	...
	/***  
	$title = ['title' => 'demo title', 'page'=>'第2页', ...] 
	用'-'粘起来, 如demo title-第2页-...
	*/
 ...
 */
 /*
执行本函数, 并执行绑定在'single_post_title'点上的所有其它函数
 */
 ...
 */
 /*** 
 加一个head, 表示html内容是由wodpress哪个版本产生的 
