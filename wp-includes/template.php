...
cms会根据query中的参数拉出不同的模板, 然后显示
 ...
 比如如果有archive-audio.php就先用它, 没有就用archive.php 
 */
...
function get_category_template() {
	...
	/* 先试category-{$category->slug}.php模板文件, 如果不存在再试category-{$category->term_id}.php, 最后试category.php */
 ...
 */
 /* 
 从一组模板挑一个出来, 返回文件名 
 STYLESHEETPATH指子模板路径, TEMPLATEPATH总是指父模板路径?
 */
