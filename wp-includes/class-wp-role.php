...
/*** 
wordpress 预定义了5种角色,及每种角色的权限, @see  schema.php populate_roles_160()
新注册用户时,可以为其指定一种角色, 如下:
$user_id = wp_create_user( $user_login, $pas1, $user_email );
$user = new WP_User($user_id);
$user->set_role('editor');	

administrator: 单站内所有权限
editor:管理所有人的贴子(不含网站设置,插件安装,主题切换...)
author: 管理自己的贴子
...
class WP_Role {
	 ...
	 * @var array
	 */
	 /*** 每个角色对应一组权限(一个权限就是一个字符串, 如'edit_post', 'manage_options') */
	public $capabilities;
