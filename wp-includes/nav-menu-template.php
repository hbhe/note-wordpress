...
function wp_nav_menu( $args = array() ) {
	...
	/*** 
	使用Walker_Nav_Menu来遍历$sorted_menu_items这种用parent id来表示的层次关系 
	输出的是<ul><li><ul><li></li></ul></li></ul>这种层次关系?
	*/
...
function walk_nav_menu_tree( $items, $depth, $r ) {
	...
	/*** $items是已经从db中取出的所有menu数据, $depth 遍历深度 */
	$args = array( $items, $depth, $r );

	/*** 调用Walker_Nav_Menu类中的walk() */
