...
/*
WP类与WP_Query类区别? 2个中都有$query_vars成员
wordpress中没有Request类, 这个WP类就相当于Request类,它的任务处理url参数
*/
...
class WP {
	...
	'm': month
	'p': 贴子id
	'page': 某贴子如有多页<!-- nextpage -->, 当前看的是第几页
	'post_parent'
	'subpost'
	'subpost_id'
	'attachment'
	 ...
	 */
	 /* 
	 因为有些老的插件使用了'query_string'这个锚点, 所以继续提供此函数
	 新插件应使用'parse_request'这个锚点
	 */
