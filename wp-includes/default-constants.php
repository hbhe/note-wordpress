...
function wp_templating_constants() {
	 ...
	 */
	 /*
	 正常情况下TEMPLATEPATH与STYLESHEETPATH相等,但有子主题两者不等
	 TEMPLATEPATH:模板所在目录, 父主题所在目录
	 STYLESHEETPATH: style.php文件所在目录,子主题所在目录
	 引用父主题目录所在资源时用TEMPLATEPATH, 要用到子主题目录内的东西时用STYLESHEETPATH	 
	 */
	 ...
	 */
	 /* 如果db中指定的当前主题不存在,就用WP_DEFAULT_THEME主题, 如果WP_DEFAULT_THEME也不存在, 就从WP_Theme::$default_themes中取一个历史上的默认主题 */
