...
class WP_Customize_Control {
	 ...
	 * @var string
	 */
	 /*** WP_Customize_Control就是编辑框, 默认支持checkbox, radio, select, textarea, text, dropdown-pages(page下拉列表) */
	public $type = 'text';
			...
			default:
				...
				<label>
					...
					if ( ! empty( $this->description ) ) : ?>
						<span class="description customize-control-description"><?php echo $this->description; ?></span>
					<?php endif; ?>
					<input type="<?php echo esc_attr( $this->type ); ?>" <?php $this->input_attrs(); ?> value="<?php echo esc_attr( $this->value() ); ?>" <?php $this->link(); /*** link()很重要, 它表明数据来源, preview ajax用到? */ ?> />
				</label>
				<?php
				break;
		}
