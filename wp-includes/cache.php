...
/*
将此文件copy到wp-content/object-cache.php, 自已用memcached实现wp_cache_get(), wp_cache_set(),....接口, 
这样此文件就不会被加载了?

这里的cache并不是真正的cache, 数据只是在当前页面请求期间共享
要想在页面之间共享数据,可用get_site_transient(), set_site_transient()
*/
