 ...
 */
 /*
在index.php所在目录存放一个.maintenance的php文件,
内容为<?php $upgrading = time(); //或者指定的一个准备进行维护的时间 ?>
...
function wp_maintenance() {
	...
	/* 如果想自定义维护公告,就将公告内容另存为wp-content/maintenance.php文件 */
 ...
 */
/*
选择启用wordpress系统中的object cache还是外部(external)实现的cache
如果存在object-cache.php文件, 就使用它,置标志wp_using_ext_object_cache为true
*/ 
