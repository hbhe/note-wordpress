...
自定义结构时, 安装rest api插件后可输入以下
http://127.0.0.1/note-wordpress/wp-json/posts/
http://127.0.0.1/note-wordpress/wp-json/post/1
http://127.0.0.1/note-wordpress/wp-json/posts?filter[posts_per_page]=2&page=2

关键点: 如果url中带rest_route这个参数,就执行rest_api_loaded()
*/
...
function rest_api_init() {
	...
	global $wp;
	/* 表示支持url中的rest_route参数,这样以后parse_request时可以解析出rest_route参数值 */
...
function rest_api_loaded() {
	...
	/* new 一个WP_REST_Server对象, class-wp-rest-server.php */
