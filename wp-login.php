 ...
 */
/***
login, register, logout  功能都在这个文件内
*/
...
/*** 如果wp-config.php中定义了RELOCATE, 就更新db中的siteurl */
...
/***
<form name="lostpasswordform" id="lostpasswordform" action="http://127.0.0.1/note-wordpress/wp-login.php?action=lostpassword" method="post">
	<p>
